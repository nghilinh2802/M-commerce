...
public class SendSMSActivity extends AppCompatActivity {
    ...
    TextView txtTelephonieName;
    TextView getTxtTelephonieNumber;
    EditText edtBody;
    ...
    private void addViews() {
        txtTelephonieName=findViewById(R.id.txtTelephonieName);
        getTxtTelephonieNumber=findViewById(R.id.txtTelephonieNumber);
        ...
        if (ti!=null)
        {
            ...
            getTxtTelephonieNumber.setText(ti.getPhone());
        }
    }
